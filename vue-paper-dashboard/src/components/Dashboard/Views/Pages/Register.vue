              ...
              <form @submit.prevent="register">
                <div class="row">
                  <div class="col-lg-6 col-md-6 ml-auto">
                    ...
                    />
                    <p class="card-title">Identity Card</p>
                    <fg-input
                      v-model="password_confirmation"
                      class="mb-2 mt-1"
                    ...
                    <fg-input
                      ...
                      required
                    />
                    <datepicker  :format="format" v-model="daterange" class="mb-2" placeholder="Date range"></datepicker>
                  <!-- Upload image -->
                    <p class="mb-2 mt-1">Front-side of your card*</p>
                    <input type="file" @change="onFileSelected" />
                    <div id="preview">
                      <img v-if="url" :src="url" />
                    </div>
                    <!-- Upload image -->
                    <p class="mb-2 mt-1">Back-side of your card*</p>
                    <input type="file" @change="onFileSelected" />
                    <div id="preview">
                      <img v-if="url" :src="url" />
                    </div>
