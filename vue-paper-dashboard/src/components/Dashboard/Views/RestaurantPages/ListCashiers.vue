        ...
        <div class="card-body">
          <div class="card-body table-responsive table-full-width">
            <el-table :data="listCashier">
              <el-table-column min-width="100" type="index"></el-table-column>
              ...
              <p-button
                  type="info"
                  v-on:click="viewDetailCashier(listCashier[scope.$index].user_id)"
                  >View</p-button
                >
...
export default {
  ...
  methods: {
    viewDetailCashier(userID) {
      console.log(userID)
      this.$router.push({name : "cashiermanagement", params: {user_id : userID}});
    },
